/**
 *      Metot mantığı ile Faktöriyel Hesaplama anlatılmıştır.  
 * @Engin İNSEL
 * @date 5.05.2021  
 */ 
package faktöriyel; 
...
public class BookExample3Faktöriyel {
    ...
    public static void main(String[] args) {
        ...
        int fakt = s.nextInt();                                                              // Kullanıcıdan girilen sayıyı fakt değişkenine atadık.
    ...
    static long hesapla(int sayi){              // long tipinde tek parametreli değer döndüren hesapla adlı bir metot oluşturduk.
        int carpim = 1;                        // integer tipinde carpim adlı bir değişken tanımladık ve 1 değerini atadık.
        for(int i=1 ; i<=sayi ; i++){         // for döngüsüyle algoritma mantığına dayalı işlem gerçekleştirildi.
